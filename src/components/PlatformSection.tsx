  ...
  return (
    <section id="platform" className="relative py-24">
      ...
      <div className="container relative mx-auto px-6">
        ...
        >
          <p className="mb-3 text-xs font-medium uppercase tracking-[0.2em] text-primary">Cy360 Security Platform</p>
          ...
          <div className="flex items-center justify-between gap-4 md:gap-8">
            ...
            >
              ...
              <div className="text-center">
                <p className="font-heading text-xs font-bold text-foreground">CY360</p>
          ...
          <div className="grid items-center gap-8 md:grid-cols-2">
            <div>
              ...
              <p className="mb-4 text-muted-foreground">
                Cy360 integrates custom Large Language Models (LLMs) to enrich alerts, automate investigations, summarize incidents, and recommend actions.
              </p>
